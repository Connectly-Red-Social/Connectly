...
def chat():
    ...
    if selected_user_id:
        ...
        selected_user, _ = community_data_instance.get_user_profile(selected_user_id)

    return render_template('chat.html',mutual_followers=mutual_followers,messages=messages,selected_user=selected_user,selected_user_id=selected_user_id)
